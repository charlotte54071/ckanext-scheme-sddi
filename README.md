...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.scheme_sddi.some_setting = some_default_value
...
## Releasing a new version of ckanext-scheme-sddi

If ckanext-scheme-sddi should be available on PyPI you can follow these steps to publish a new version:
